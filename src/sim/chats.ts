...
// =========================================================================
// LEGACY M2.1 注意事項
//   このファイル内で「ondo / 音頭 / 太鼓 / ココン参戦 / スズ点呼」を直接参照
//   する pool（PARTICIPATE_ONDO 系、cocoon_*、suzu_* 等）は M2.1 廃止予定。
//   新規発火は M2.1 Step 2/3 で停止する。プール自体は legacy の図鑑/履歴
//   再現用に残す。
//   新規ちびわふセリフは「画面上の因果から読める状況反応」を優先する。
//   詳細: docs/M2-DIRECTION-RESET.md / docs/DIALOGUE-CATALOG.md
// =========================================================================
...
export const ACTION_ANNOUNCE: Record<string, string[]> = {
  ...
  work                : ['はたらくわふ！', 'あれ片付けるわふ', 'えいえいわふ', 'かたづけるわふ'],
  farm_eat            : ['ごはんほしいわふ', 'はたけへいくわふ', 'もぐもぐするわふ', 'くうわふ！'],
  // 状態遷移別
