...
| 16 | 赤リボン | 頭上（耳の付け根） | akachan感 | Red ribbon bow (color fixed at `#E05860`, NOT peach-pink) tied at the base of one ear. **注**: 尻尾根元の桃色リボン (`#F9C4A1`) と色・位置で区別すること。アクセサリ版は耳元で色は `#E05860` 固定 |
...
- v0.3 10_character_design.md v0.5 に合わせて尻尾根元リボン色参照を `#F9C4A1` に更新
